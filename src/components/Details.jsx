...
const Details = () => {
    return (
        <main className='flex m-4 py-4'>

            <div className='w-5/6 text-white flex  flex-col ml-auto mr-auto text-lg gap-4 m-4 py-4'>
                ...
                <div className='grid grid-cols-2'>
                    ...
                    <div className='flex flex-col'>
                        <strong>Cosmonaut</strong>
                        Back-up cosmonaut Ravish Malhotra's suit at Nehru Planetarium
                    ...
                    <div className='gap-5 flex flex-col m-4 py-4'>
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Rakesh_sharma.jpg/330px-Rakesh_sharma.jpg" />
                ...
                <div className='grid grid-cols-2'>
                    <div className='gap-5 flex flex-col m-4 py-4'>
                        ...
                        <img src="https://punjabkesari.com/upload/2023/07/1690019158_feature_2.png"  />
                    </div>
                    <div className='flex flex-col'>
                        <strong>Post-retirement</strong>
